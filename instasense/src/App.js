    ...
    <NewRootRoot>
      <Frame12>
        ...
        <Frame3>
          ...
          <Typeprimary3 type={"primary"} />
        </Frame3>
      </Frame12>
    </NewRootRoot>
  );
};
const Component51 = ({ className }) => {
  return (
    <Component5 className={className}>
      <Group4>
        <Image6
          src={
            "https://firebasestorage.googleapis.com/v0/b/rendition-prod.appspot.com/o/e46c2fbb-562d-4239-b266-069601f65406.png?alt=media&token=ea64e491-3298-4a75-983b-ec2a859ab545"
          }
        />
        <Image6
          src={
            "https://firebasestorage.googleapis.com/v0/b/rendition-prod.appspot.com/o/13f2ee81-8470-42f2-810b-192fbe5dfb13.png?alt=media&token=a2fb8b03-d67a-4ffb-a6d0-693be9295cee"
          }
        />
      </Group4>
      <Image5
  ...
  return (
    <Component4 className={className}>
      ...
      <Group2>
        ...
        <_1ItemSelected>1 Item Selected.</_1ItemSelected>
      </Group2>
      <Component2 type={"secondary"} />
      <Component1 type={"primary"} />
    </Component4>
  );
};
